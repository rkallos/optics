...
enum optics_ret optics_counter_read(
        struct optics_lens *lens, optics_epoch_t epoch, int64_t *value);
...
enum optics_ret optics_gauge_read(
        struct optics_lens *lens, optics_epoch_t epoch, double *value);
...
enum optics_ret optics_dist_read(
        struct optics_lens *lens, optics_epoch_t epoch, struct optics_dist *value);
...
enum optics_ret optics_histo_read(
        struct optics_lens *lens, optics_epoch_t epoch, struct optics_histo *value);
